...
const getBackground = (props) => {
  let style = {};
  let heroImgUrl =
    "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAYAAAAGCAYAAADgzO9IAAAAOElEQVQIW2MUFBT8//79ewYQALLBNIjP6OLiApe4d+8eg5KSEsPZs2chEiAGSIB4CZgdKDpwWQ4A7Mc2AV5T93AAAAAASUVORK5CYII=) repeat";
  if (props.heroImgUrl) {
...
export default function Hero(props) {
  return (
    <div className="hero">
      <div style={getTextStyle(props)}>{props.children}</div>
      <div style={getCoverStyle(props)}></div>
    </div>
  );
}
