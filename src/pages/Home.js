    ...
    <Layout>
      ...
      <Section sectionId="about">
        ...
        <code>
          ...
          HTML/CSS
          <br />
          Javascript (Vue, React, AngularJS)
          <br />
          UI/UX/Brand (Sktech / Photoshop / InDesign)
          <br />
        ...
        <p className="about-links">
          <a href="mailto:ktu@jkevintu.com">ktu@jkevintu.com</a>
          <br />
          <br />
          <a href="https://www.linkedin.com/in/jkevintu">>> linkedin</a>
          <br />
          <a href="https://github.com/jkevintu">>> Github</a>
          <br />
          <a href="https://stackoverflow.com/users/527376/ktu">
            >> Stackoverflow
          </a>
        </p>
      </Section>
