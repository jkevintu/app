    ...
    <ProjectLayout>
      ...
      <Section className="flex">
        <SectionProjectDesc className="large">
          <p className="project-major-desc">
            Collection of websites built for companies, government or non-profit organizations.
          </p>
        </SectionProjectDesc>
        ...
        <div className="desc-wrapper">
            ...
            <div className="desc-content">
              Design<br/>Development<br/>Hosting<br/>Marketing
            </div>
          </div>
        </SectionProjectDesc>
      </Section>
      {
        websites.length && websites.map(website => {
          ...
          return (
            <Section>
              <SectionProfileImage name={website.name} imgURL={website.imageURL}/>
              <SectionProfileWrapper>
                <SectionProfileDetail className="title">
                  {website.timeframe && <div className="timeframe">{website.timeframe}</div>}
                  {website.name}
                  <hr/>
                  { website.url &&
